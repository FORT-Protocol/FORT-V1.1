...
exports.deploy = async function() {
    ...
    // fortVaultForStakinggggg: 0x176D7C08e5BC8f7334a1b1A5DC2C3516F80e1195
    ...
    //const fortVaultForStakinggggg = await upgrades.deployProxy(FortVaultForStaking, [fortGovernance.address], { initializer: 'initialize' });
    const fortVaultForStakinggggg = await FortVaultForStaking.attach('0x176D7C08e5BC8f7334a1b1A5DC2C3516F80e1195');
    console.log('fortVaultForStakinggggg: fortVaultForStakingngngngng.address);
    ...
    // // await fortVaultForStakinggggg.initialize(fortGovernance.address);
    ...
    //     fortOptions.address,
    //     fortFutures.address,
    //     fortVaultForStakinggggg.address,
    ...
    // console.log('7. fortVaultForStakinggggg.update()');
    // await fortVaultForStakinggggg.update(fortGovernance.address);
    ...
    // console.log('11. dcu.setMinter(fortVaultForStakinggggg.address, 1)');
    // await dcu.setMinter(fortVaultForStakinggggg.address, 1);
    ...
    const contracts = {
        ...
        fortVaultForStakingggfortVaultForStakingngngngng,
