...
contract HedgeOptions is HedgeFrequentlyUsed, IHedgeOptions {
    ...
    // Mapping from composite key to option index
    ...
    function open(
        ...
        // 3. Get the option, if not exist, create it
    ...
    // Compose key by tokenAddress, strikePrice, orientation and exerciseBlock
    function _getKey(
        address tokenAddress, 
        uint strikePrice, 
        bool orientation, 
