...
describe('FortOptions', function() {
    it('First', async function() {
        ...
        if (true) {
            ...
            expect(await fortGovernance.getFortOptionsAddress()).to.eq(fortOptions.address);
            expect(await fortGovernance.getFortFuturesAddress()).to.eq(fortFutures.address);
        ...
        if (true) {
            ...
            expect(await fortGovernance.getFortOptionsAddress()).to.eq('0x0000000000000000000000000000000000000003');
            expect(await fortGovernance.getFortFuturesAddress()).to.eq('0x0000000000000000000000000000000000000004');
